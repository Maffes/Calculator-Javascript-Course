import { IRectangle, Rectangle } from "./classes/rectangle.js";
import { ITriangle, Triangle } from "./classes/triangle.js"
import { ITrapezoid, Trapezoid } from "./classes/trapezoid.js"
...
class AreaCalculator {
  ...
  updateAnswer(type: string, baseUnit: string, answer: string, value1: any, value2: any, value3: any, s: any) {)
    if (type == 'Rectangle') {
  ...
  updateImportTable(type: string, value1: string, value1Unit: string, value2: string, value2Unit: string, value3: string, value3Unit: string, answer: string) {
  ...
  rectangle(baseUnit: string, value1: any, value1Unit: string, value2: any, value2Unit: string, dataImport: boolean) {
    let value3 = ''
    let value3Unit = ''
    ...
    let variable:IRectangle = {value1: value1, value2:value2};
  ...
  triangle(baseUnit: string, value1: any, value1Unit: string, value2: any, value2Unit: string, value3: any, value3Unit: string, dataImport: boolean) {
    ...
    if (parseFloat(value1) + parseFloat(value2) > parseFloat(value3)) {
      ...
      let variable:ITriangle = {value1: value1, value2:value2, value3:value3};
  ...
  trapezoid(baseUnit: string, value1: any, value1Unit: string, value2: any, value2Unit: string, value3: any, value3Unit: string, dataImport: boolean) {
    console.log(value1)
    console.log(value2)
    console.log(value3)
    if (value1 <= 0 || value2 <= 0 || value3 <= 0) {
    ...
    let variable:ITrapezoid = {value1: value1, value2:value2, value3:value3};
  ...
  unitConverter(baseUnit: any, value: number, valueUnit: string) {
